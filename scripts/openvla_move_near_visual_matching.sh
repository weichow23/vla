...
rgb_overlay_path=real_inpainting/google_move_near_real_eval_1.png
...
do CUDA_VISIBLE_DEVICES=${gpu_id} python eval/simpler/main_inference.py --policy-model openvla --ckpt-path ${ckpt_path} --config_path ${config_path} \
