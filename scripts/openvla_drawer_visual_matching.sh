...
EvalOverlay() {
# A0
python eval/simpler/main_inference.py --policy-model openvla --ckpt-path ${ckpt_path} --config_path ${config_path} \
  ...
  --rgb-overlay-path real_inpainting/open_drawer_a0.png \
  ${EXTRA_ARGS}
...
python eval/simpler/main_inference.py --policy-model openvla --ckpt-path ${ckpt_path} --config_path ${config_path} \
  ...
  --obj-init-x-range 0 0 1 --obj-init-y-range 0 0 1 \
  --rgb-overlay-path real_inpainting/open_drawer_a1.png \
  ${EXTRA_ARGS}
...
python eval/simpler/main_inference.py --policy-model openvla --ckpt-path ${ckpt_path} --config_path ${config_path} \
  ...
  --obj-init-x-range 0 0 1 --obj-init-y-range 0 0 1 \
  --rgb-overlay-path real_inpainting/open_drawer_a2.png \
  ${EXTRA_ARGS}
...
python eval/simpler/main_inference.py --policy-model openvla --ckpt-path ${ckpt_path} --config_path ${config_path} \
  ...
  --obj-init-x-range 0 0 1 --obj-init-y-range 0 0 1 \
  --rgb-overlay-path real_inpainting/open_drawer_b0.png \
  ${EXTRA_ARGS}
...
python eval/simpler/main_inference.py --policy-model openvla --ckpt-path ${ckpt_path} --config_path ${config_path} \
  ...
  --robot-init-rot-quat-center 0 0 0 1 --robot-init-rot-rpy-range 0 0 1 0 0 1 0 0 1 \
  --obj-init-x-range 0 0 1 --obj-init-y-range 0 0 1 \
  --rgb-overlay-path real_inpainting/open_drawer_b1.png \
  ${EXTRA_ARGS}
...
python eval/simpler/main_inference.py --policy-model openvla --ckpt-path ${ckpt_path} --config_path ${config_path} \
  ...
  --robot-init-rot-quat-center 0 0 0 1 --robot-init-rot-rpy-range 0 0 1 0 0 1 0 0 1 \
  --obj-init-x-range 0 0 1 --obj-init-y-range 0 0 1 \
  --rgb-overlay-path real_inpainting/open_drawer_b2.png \
  ${EXTRA_ARGS}
...
python eval/simpler/main_inference.py --policy-model openvla --ckpt-path ${ckpt_path} --config_path ${config_path} \
  ...
  --robot-init-rot-quat-center 0 0 0 1 --robot-init-rot-rpy-range 0 0 1 0 0 1 0 0 1 \
  --obj-init-x-range 0 0 1 --obj-init-y-range 0 0 1 \
  --rgb-overlay-path real_inpainting/open_drawer_c0.png \
  ${EXTRA_ARGS}
...
python eval/simpler/main_inference.py --policy-model openvla --ckpt-path ${ckpt_path} --config_path ${config_path} \
  ...
  --obj-init-x-range 0 0 1 --obj-init-y-range 0 0 1 \
  --rgb-overlay-path real_inpainting/open_drawer_c1.png \
  ${EXTRA_ARGS}
...
python eval/simpler/main_inference.py --policy-model openvla --ckpt-path ${ckpt_path} --config_path ${config_path} \
  ...
  --robot-init-rot-quat-center 0 0 0 1 --robot-init-rot-rpy-range 0 0 1 0 0 1 -0.025 -0.025 1 \
  --obj-init-x-range 0 0 1 --obj-init-y-range 0 0 1 \
  --rgb-overlay-path real_inpainting/open_drawer_c2.png \
  ${EXTRA_ARGS}
}
